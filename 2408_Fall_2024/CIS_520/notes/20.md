    ...
    - the decoder $`g`$ goes   
      - In vector form   
        $`\begin{aligned}
          ...
          &= \begin{bmatrix} (\mathbf{q}_1^\top\mathbf{x}_i)\mathbf{q}_{11} + (\mathbf{q}_2^\top\mathbf{x}_i)\mathbf{q}_{21} + \cdots + (\mathbf{q}_d^\top\mathbf{x}_i)\mathbf{q}_{d1} \\ 
          (\mathbf{q}_1^\top\mathbf{x}_i)\mathbf{q}_{12} + (\mathbf{q}_2^\top\mathbf{x}_i)\mathbf{q}_{22} + \cdots + (\mathbf{q}_d^\top\mathbf{x}_i)\mathbf{q}_{d2} \\ \vdots \\  
          (\mathbf{q}_1^\top\mathbf{x}_i)\mathbf{q}_{1D} + (\mathbf{q}_2^\top\mathbf{x}_i)\mathbf{q}_{2D} + \cdots + (\mathbf{q}_d^\top\mathbf{x}_i)\mathbf{q}_{dD} \end{bmatrix} \\ 
          &= \begin{bmatrix} (\mathbf{q}_1^\top\mathbf{x}_i)\mathbf{q}_1 + (\mathbf{q}_2^\top\mathbf{x}_i)\mathbf{q}_2 + \cdots + (\mathbf{q}_d^\top\mathbf{x}_i)\mathbf{q}_d \end{bmatrix} \in\mathbb{R}^D
        \end{aligned}`$
      - In matrix form   
        $`\begin{aligned}
          \mathbf{XQ^\top Q} 
