    ...
    - the decoder $`g`$ goes   
      ...
      - In matrix form   
        $`\begin{aligned}
          ...
          &= \begin{bmatrix} (\mathbf{x}_1^\top\mathbf{q}_1)\mathbf{q}_1^\top + (\mathbf{x}_1^\top\mathbf{q}_2)\mathbf{q}_2^\top + \cdots (\mathbf{x}_1^\top\mathbf{q}_d)\mathbf{q}_d^\top \\ (\mathbf{x}_2^\top\mathbf{q}_1)\mathbf{q}_1^\top + (\mathbf{x}_2^\top\mathbf{q}_2)\mathbf{q}_2^\top + \cdots (\mathbf{x}_2^\top\mathbf{q}_d)\mathbf{q}_d^\top \\ \vdots \\ (\mathbf{x}_n^\top\mathbf{q}_1)\mathbf{q}_1^\top + (\mathbf{x}_n^\top\mathbf{q}_2)\mathbf{q}_2^\top + \cdots (\mathbf{x}_n^\top\mathbf{q}_d)\mathbf{q}_d^\top \\  \end{bmatrix} \\
