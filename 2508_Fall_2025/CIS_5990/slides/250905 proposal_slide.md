...
### Assumptions
  ...
  <img class="right-img" src="../images/concepts/moby_dic_goal.png" width="350px">
</div>
...
### Strategy 1 : Clustering (in which space?)
...
|Inter-Cluster|![h:220px](../images/concepts/search-inter-cluster.png)|
