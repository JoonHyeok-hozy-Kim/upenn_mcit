# CI5950 Computer Systems Programming
...
| 4|[OS Start: Processes & Fork](notes/04.md)|- OS, Process, `fork()`, `EXIT_SUCCESS`, `EXIT_FAILURE` <br> - Accessing C arrays : `std::array`, `std::string.c_str()` <br> - `execvp()`, `wait()`, `waitpid()`|
| 5|[](notes/05.md)|- |
| 6|[]()|- |
| 7|[]()|- |
| 8|[]()|- |
